const api = {
  ...
  blockUser(userId) { return this.post(`/api/blocks/${userId}`, {}); },
  unblockUser(userId) { return this.req('DELETE', `/api/blocks/${userId}`); },
  getBlockStatus(userId) { return this.get(`/api/blocks/status/${userId}`); },
