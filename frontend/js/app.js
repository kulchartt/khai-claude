...
const respMins=seller.avg_response_minutes;const respLabel=seller.response_count>=3?(respMins<60?'⚡ ตอบเร็วมาก':respMins<240?`🟢 ตอบใน ${Math.round(respMins/60)} ชม.`:respMins<1440?`🟡 ตอบใน ${Math.round(respMins/60)} ชม.`:`🔴 ตอบใน ${Math.round(respMins/1440)} วัน`):null;
